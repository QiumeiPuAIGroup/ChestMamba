...
def plot_history(epochs, Acc, Loss, lr, save_dir=""):
    ...
    # plt.show()
    save_path = os.path.join(save_dir, "loss.svg")
    ...
    plt.legend(['train', 'test'], loc='upper left')
    # plt.show()
    save_path = os.path.join(save_dir, "acc.svg")
    fig.savefig(save_path, format="svg")
    ...
    plt.ylabel('Train LR')
    # plt.show()
    save_path = os.path.join(save_dir, "lr.svg")
    fig.savefig(save_path, format="svg")
